    ...
    <div className="mt-12">
        ...
        <div className="bg-white dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$65,477.099</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-3 rounded-2xl md:w-780">
          ...
          <div className="mt-10 flex gap-10 flex-wra justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-semibold">$ 93,232</span>
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">$ 40,202</span>
                </p>
